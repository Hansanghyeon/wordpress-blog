...
/** Set relationships between the Blog to BlogCategory */
export interface BlogBlogCategoryInput {
  /** If true, this will append the BlogCategory to existing related BlogCategory. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars["Boolean"]>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<BlogBlogCategoryNodeInput>>>;
}

/** List of BlogCategory to connect the Blog to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export interface BlogBlogCategoryNodeInput {
  /** The description of the BlogCategory. This field is used to set a description of the BlogCategory if a new one is created during the mutation. */
  description?: InputMaybe<Scalars["String"]>;
  /** The ID of the BlogCategory. If present, this will be used to connect to the Blog. If no existing BlogCategory exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars["ID"]>;
  /** The name of the BlogCategory. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars["String"]>;
  /** The slug of the BlogCategory. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
...
/** Arguments for filtering the BlogCategoryToBlogConnection connection */
export interface BlogCategoryToBlogConnectionWhereArgs {
...
export interface BlogCategoryToContentNodeConnectionWhereArgs {
  ...
  contentTypes?: InputMaybe<Array<InputMaybe<ContentTypesOfBlogCategoryEnum>>>;
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars["Boolean"]>;
...
/** Set relationships between the Blog to Seriess */
export interface BlogSeriessInput {
  /** If true, this will append the Series to existing related Seriess. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars["Boolean"]>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<BlogSeriessNodeInput>>>;
}

/** List of Seriess to connect the Blog to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export interface BlogSeriessNodeInput {
  ...
  description?: InputMaybe<Scalars["String"]>;
  /** The ID of the Series. If present, this will be used to connect to the Blog. If no existing Series exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars["ID"]>;
...
/** Arguments for filtering the BlogToBlogCategoryConnection connection */
export interface BlogToBlogCategoryConnectionWhereArgs {
...
export interface BlogToCommentConnectionWhereArgs {
...
/** Arguments for filtering the BlogToSeriesConnection connection */
export interface BlogToSeriesConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Arguments for filtering the BlogToTermNodeConnection connection */
export interface BlogToTermNodeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export enum ContentTypesOfBlogCategoryEnum {
  /** The Type of Content object */
  BLOG = "BLOG",
}
...
export enum ContentTypesOfSeriesEnum {
  /** The Type of Content object */
  BLOG = "BLOG",
  /** The Type of Content object */
  DEV = "DEV",
...
/** Input for the createBlogCategory mutation */
export interface CreateBlogCategoryInput {
  /** The slug that the blog_category will be an alias of */
  aliasOf?: InputMaybe<Scalars["String"]>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The description of the blog_category object */
  description?: InputMaybe<Scalars["String"]>;
  /** The name of the blog_category object to mutate */
  name: Scalars["String"];
...
export interface CreateBlogInput {
  /** Set connections between the Blog and BlogCategory */
  blogCategory?: InputMaybe<BlogBlogCategoryInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  ...
  password?: InputMaybe<Scalars["String"]>;
  /** Set connections between the Blog and Seriess */
  seriess?: InputMaybe<BlogSeriessInput>;
...
export interface CreateDevInput {
  ...
  /** The password used to protect the content of the object */
  password?: InputMaybe<Scalars["String"]>;
  /** Set connections between the Dev and Seriess */
  seriess?: InputMaybe<DevSeriessInput>;
  /** The slug of the object */
  slug?: InputMaybe<Scalars["String"]>;
  /** The status of the object */
  status?: InputMaybe<PostStatusEnum>;
...
/** Input for the deleteBlogCategory mutation */
export interface DeleteBlogCategoryInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The ID of the BlogCategory to delete */
  id: Scalars["ID"];
}
...
/** Input for the deleteStackoverflow mutation */
export interface DeleteStackoverflowInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars["Boolean"]>;
  /** The ID of the Stackoverflow to delete */
  id: Scalars["ID"];
}
...
/** Set relationships between the Dev to Seriess */
export interface DevSeriessInput {
  /** If true, this will append the Series to existing related Seriess. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars["Boolean"]>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<DevSeriessNodeInput>>>;
}

/** List of Seriess to connect the Dev to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export interface DevSeriessNodeInput {
  /** The description of the Series. This field is used to set a description of the Series if a new one is created during the mutation. */
  description?: InputMaybe<Scalars["String"]>;
  /** The ID of the Series. If present, this will be used to connect to the Dev. If no existing Series exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars["ID"]>;
  /** The name of the Series. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars["String"]>;
  /** The slug of the Series. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
...
/** Arguments for filtering the DevToCommentConnection connection */
export interface DevToCommentConnectionWhereArgs {
  /** Comment author email address. */
  authorEmail?: InputMaybe<Scalars["String"]>;
  /** Array of author IDs to include comments for. */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface DevToSeriesConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export enum MimeTypeEnum {
  ...
  APPLICATION_VND_MS_FONTOBJECT = "APPLICATION_VND_MS_FONTOBJECT",
  ...
  APPLICATION_X_FONT_OPENTYPE = "APPLICATION_X_FONT_OPENTYPE",
...
/** Arguments for filtering the RootQueryToBlogCategoryConnection connection */
export interface RootQueryToBlogCategoryConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export interface RootQueryToBlogConnectionWhereArgs {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars["Boolean"]>;
...
export interface RootQueryToSeriesConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Arguments for filtering the SeriesToBlogConnection connection */
export interface SeriesToBlogConnectionWhereArgs {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars["Boolean"]>;
...
export interface SeriesToContentNodeConnectionWhereArgs {
  /** The Types of content to filter */
  contentTypes?: InputMaybe<Array<InputMaybe<ContentTypesOfSeriesEnum>>>;
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars["Boolean"]>;
...
export interface SeriesToDevConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum StackoverflowIdType {
  /** Identify a resource by the Database ID. */
  DATABASE_ID = "DATABASE_ID",
  /** Identify a resource by the (hashed) Global ID. */
  ID = "ID",
...
/** Input for the UpdateBlogCategory mutation */
export interface UpdateBlogCategoryInput {
  ...
  /** The description of the blog_category object */
  description?: InputMaybe<Scalars["String"]>;
  /** The ID of the BlogCategory object to update */
  id: Scalars["ID"];
  /** The name of the blog_category object to mutate */
  name?: InputMaybe<Scalars["String"]>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
...
export interface UpdateStackoverflowInput {
  ...
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars["String"]>;
  /** The ID of the Stackoverflow object */
  id: Scalars["ID"];
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: InputMaybe<Scalars["Int"]>;
  /** The ID of the parent object */
...
export interface UserToDevConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export const generatedSchema = {
  ...
  Blog: {
    __typename: { __type: "String!" },
    blocks: { __type: "String" },
    blogCategory: {
      __type: "BlogToBlogCategoryConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "BlogToBlogCategoryConnectionWhereArgs",
      },
    },
    blogId: { __type: "Int!" },
    ...
    comments: {
      __type: "BlogToCommentConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "BlogToCommentConnectionWhereArgs",
      },
    },
    ...
    seriess: {
      ...
      __args: {
        ...
        first: "Int",
        last: "Int",
        where: "BlogToSeriesConnectionWhereArgs",
      },
    },
    slug: { __type: "String" },
    ...
    terms: {
      __type: "BlogToTermNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "BlogToTermNodeConnectionWhereArgs",
      },
    },
    title: {
      __type: "String",
  ...
  BlogBlogCategoryInput: {
    append: { __type: "Boolean" },
    nodes: { __type: "[BlogBlogCategoryNodeInput]" },
  },
  BlogBlogCategoryNodeInput: {
  ...
  BlogCategory: {
    __typename: { __type: "String!" },
    blogCategoryId: { __type: "Int" },
    blogs: {
      __type: "BlogCategoryToBlogConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "BlogCategoryToBlogConnectionWhereArgs",
      },
    },
    conditionalTags: { __type: "ConditionalTags" },
    contentNodes: {
      __type: "BlogCategoryToContentNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
  ...
  BlogCategoryToBlogConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[BlogCategoryToBlogConnectionEdge]" },
    nodes: { __type: "[Blog]" },
  ...
  BlogCategoryToBlogConnectionWhereArgs: {
  ...
  BlogCategoryToContentNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[BlogCategoryToContentNodeConnectionEdge]" },
  ...
  BlogCategoryToContentNodeConnectionWhereArgs: {
    contentTypes: { __type: "[ContentTypesOfBlogCategoryEnum]" },
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
  ...
  BlogSeriessInput: {
    append: { __type: "Boolean" },
    nodes: { __type: "[BlogSeriessNodeInput]" },
  },
  BlogSeriessNodeInput: {
    description: { __type: "String" },
    id: { __type: "ID" },
    name: { __type: "String" },
    slug: { __type: "String" },
  ...
  BlogToBlogCategoryConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[BlogToBlogCategoryConnectionEdge]" },
    nodes: { __type: "[BlogCategory]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  BlogToBlogCategoryConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "BlogCategory" },
  },
  BlogToBlogCategoryConnectionWhereArgs: {
  ...
  BlogToCommentConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[BlogToCommentConnectionEdge]" },
    nodes: { __type: "[Comment]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  BlogToCommentConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Comment" },
  },
  BlogToCommentConnectionWhereArgs: {
  ...
  BlogToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Blog" },
  },
  BlogToSeriesConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[BlogToSeriesConnectionEdge]" },
    nodes: { __type: "[Series]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  BlogToSeriesConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Series" },
  },
  BlogToSeriesConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  BlogToTermNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[BlogToTermNodeConnectionEdge]" },
  ...
  BlogToTermNodeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  CreateBlogCategoryPayload: {
    __typename: { __type: "String!" },
    blogCategory: { __type: "BlogCategory" },
    clientMutationId: { __type: "String" },
  },
  CreateBlogInput: {
    blogCategory: { __type: "BlogBlogCategoryInput" },
    clientMutationId: { __type: "String" },
    commentStatus: { __type: "String" },
    ...
    password: { __type: "String" },
    seriess: { __type: "BlogSeriessInput" },
    slug: { __type: "String" },
    status: { __type: "PostStatusEnum" },
    title: { __type: "String" },
  },
  ...
  CreateDevInput: {
    ...
    menuOrder: { __type: "Int" },
    password: { __type: "String" },
    seriess: { __type: "DevSeriessInput" },
    slug: { __type: "String" },
    status: { __type: "PostStatusEnum" },
    title: { __type: "String" },
  },
  ...
  CreateStackoverflowPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    stackoverflow: { __type: "Stackoverflow" },
  },
  CreateTagInput: {
    aliasOf: { __type: "String" },
    clientMutationId: { __type: "String" },
  ...
  Dev: {
    ...
    modified: { __type: "String" },
    modifiedGmt: { __type: "String" },
    preview: { __type: "DevToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    revisionOf: { __type: "NodeWithRevisionsToContentNodeConnectionEdge" },
    revisions: {
      __type: "DevToRevisionConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
    ...
    seriess: {
      ...
      __args: {
        ...
        first: "Int",
        last: "Int",
        where: "DevToSeriesConnectionWhereArgs",
      },
    },
    slug: { __type: "String" },
    status: { __type: "String" },
  ...
  DevSeriessInput: {
    append: { __type: "Boolean" },
    nodes: { __type: "[DevSeriessNodeInput]" },
  },
  DevSeriessNodeInput: {
    description: { __type: "String" },
    id: { __type: "ID" },
  ...
  DevToCommentConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[DevToCommentConnectionEdge]" },
    nodes: { __type: "[Comment]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ...
  DevToCommentConnectionWhereArgs: {
    authorEmail: { __type: "String" },
    authorIn: { __type: "[ID]" },
    authorNotIn: { __type: "[ID]" },
    authorUrl: { __type: "String" },
  ...
  DevToRevisionConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[DevToRevisionConnectionEdge]" },
    nodes: { __type: "[Dev]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ...
  DevToRevisionConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  DevToSeriesConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[DevToSeriesConnectionEdge]" },
    nodes: { __type: "[Series]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  DevToSeriesConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Series" },
  },
  DevToSeriesConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  MenuItem: {
    ...
    thumbnail: { __type: "MenuItemThumbnail", __args: { test: "Boolean" } },
    title: { __type: "String" },
    uri: { __type: "String" },
    url: { __type: "String" },
  },
  ...
  MenuItemThumbnail: {
    __typename: { __type: "String!" },
    label_color: { __type: "String" },
    menu_icon: { __type: "String" },
  },
  ...
  RootQueryToBlogCategoryConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToBlogCategoryConnectionEdge]" },
    nodes: { __type: "[BlogCategory]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToBlogCategoryConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "BlogCategory" },
  },
  RootQueryToBlogCategoryConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  RootQueryToBlogConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToBlogConnectionEdge]" },
    nodes: { __type: "[Blog]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToBlogConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Blog" },
  },
  RootQueryToBlogConnectionWhereArgs: {
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
  ...
  RootQueryToDevConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToSeriesConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToSeriesConnectionEdge]" },
    nodes: { __type: "[Series]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToSeriesConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Series" },
  },
  RootQueryToSeriesConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  RootQueryToStackoverflowConnection: {
    ...
    nodes: { __type: "[Stackoverflow]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToStackoverflowConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Stackoverflow" },
  },
  RootQueryToStackoverflowConnectionWhereArgs: {
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
  ...
  Series: {
    __typename: { __type: "String!" },
    blogs: {
      __type: "SeriesToBlogConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "SeriesToBlogConnectionWhereArgs",
      },
    },
    conditionalTags: { __type: "ConditionalTags" },
    contentNodes: {
      __type: "SeriesToContentNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
    ...
    description: { __type: "String" },
    devs: {
      __type: "SeriesToDevConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "SeriesToDevConnectionWhereArgs",
      },
    },
    enqueuedScripts: {
      __type: "TermNodeToEnqueuedScriptConnection",
  ...
  SeriesToBlogConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[SeriesToBlogConnectionEdge]" },
    nodes: { __type: "[Blog]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ...
  SeriesToBlogConnectionWhereArgs: {
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
  ...
  SeriesToContentNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[SeriesToContentNodeConnectionEdge]" },
    nodes: { __type: "[ContentNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  SeriesToContentNodeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "ContentNode" },
  },
  SeriesToContentNodeConnectionWhereArgs: {
    contentTypes: { __type: "[ContentTypesOfSeriesEnum]" },
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
  ...
  SeriesToDevConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[SeriesToDevConnectionEdge]" },
    nodes: { __type: "[Dev]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  SeriesToDevConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Dev" },
  },
  SeriesToDevConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  User: {
    ...
    description: { __type: "String" },
    devs: {
      __type: "UserToDevConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToDevConnectionWhereArgs",
      },
    },
    email: { __type: "String" },
    enqueuedScripts: {
  ...
  UserToDevConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToDevConnectionEdge]" },
    nodes: { __type: "[Dev]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToDevConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Dev" },
  },
  UserToDevConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  mutation: {
    __typename: { __type: "String!" },
    createBlog: {
      __type: "CreateBlogPayload",
      __args: { input: "CreateBlogInput!" },
    },
    createBlogCategory: {
      __type: "CreateBlogCategoryPayload",
      __args: { input: "CreateBlogCategoryInput!" },
    },
    createBook: {
    ...
    createSeries: {
      __type: "CreateSeriesPayload",
      __args: { input: "CreateSeriesInput!" },
    },
    createShortcutPost: {
    ...
    deleteBlog: {
      __type: "DeleteBlogPayload",
      __args: { input: "DeleteBlogInput!" },
    },
    deleteBlogCategory: {
      __type: "DeleteBlogCategoryPayload",
      __args: { input: "DeleteBlogCategoryInput!" },
    },
    deleteBook: {
    ...
    deleteSeries: {
      __type: "DeleteSeriesPayload",
      __args: { input: "DeleteSeriesInput!" },
    },
    deleteShortcutPost: {
    ...
    deleteStackoverflow: {
      ...
      __args: { input: "DeleteStackoverflowInput!" },
    },
    deleteTag: {
    ...
    updateBlog: {
      __type: "UpdateBlogPayload",
      __args: { input: "UpdateBlogInput!" },
    },
    updateBlogCategory: {
      __type: "UpdateBlogCategoryPayload",
      __args: { input: "UpdateBlogCategoryInput!" },
    },
    updateBook: {
    ...
    updateSeries: {
      __type: "UpdateSeriesPayload",
      __args: { input: "UpdateSeriesInput!" },
    },
    updateSettings: {
    ...
    updateStackoverflow: {
      ...
      __args: { input: "UpdateStackoverflowInput!" },
    },
    updateTag: {
  ...
  query: {
    __typename: { __type: "String!" },
    allBlogCategory: {
      __type: "RootQueryToBlogCategoryConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToBlogCategoryConnectionWhereArgs",
      },
    },
    allSettings: { __type: "Settings" },
    allUrls: { __type: "[String]" },
    blog: {
      __type: "Blog",
      __args: { asPreview: "Boolean", id: "ID!", idType: "BlogIdType" },
    },
    blogBy: {
      __type: "Blog",
      __args: { blogId: "Int", id: "ID", slug: "String", uri: "String" },
    },
    blogCategory: {
      __type: "BlogCategory",
      __args: { id: "ID!", idType: "BlogCategoryIdType" },
    },
    blogs: {
      __type: "RootQueryToBlogConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
    ...
    book: {
      __type: "Book",
      __args: { asPreview: "Boolean", id: "ID!", idType: "BookIdType" },
    },
    bookBy: {
      __type: "Book",
      __args: { bookId: "Int", id: "ID", slug: "String", uri: "String" },
    },
    books: {
    ...
    devs: {
      ...
      __args: {
        ...
        first: "Int",
        last: "Int",
        where: "RootQueryToDevConnectionWhereArgs",
      },
    },
    discussionSettings: { __type: "DiscussionSettings" },
    generalSettings: { __type: "GeneralSettings" },
    ...
    series: { __type: "Series", __args: { id: "ID!", idType: "SeriesIdType" } },
    seriess: {
      __type: "RootQueryToSeriesConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
    ...
    stackoverflow: {
      ...
      __args: {
        asPreview: "Boolean",
        id: "ID!",
        idType: "StackoverflowIdType",
      },
    },
    stackoverflowBy: {
      __type: "Stackoverflow",
      __args: { id: "ID", stackoverflowId: "Int", uri: "String" },
    },
    stackoverflows: {
      __type: "RootQueryToStackoverflowConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToStackoverflowConnectionWhereArgs",
      },
    },
  ...
  [SchemaUnionsKey]: {
    ...
    NodeWithComments: ["Blog", "Dev", "MediaItem", "Page", "Post"],
    NodeWithContentEditor: [
      "Blog",
      "Book",
      "Dev",
    ...
    NodeWithAuthor: ["Dev", "MediaItem", "Page", "Post"],
    NodeWithRevisions: ["Dev", "Page", "Post"],
    EnqueuedAsset: ["EnqueuedScript", "EnqueuedStylesheet"],
    HierarchicalContentNode: ["MediaItem", "Page", "Stackoverflow"],
    MenuItemObjectUnion: [
      "Blog",
      "BlogCategory",
      "Book",
...
export interface Blog {
   ...
   */
  blocks?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the Blog type and the BlogCategory type
   */
  blogCategory: (args?: {
    /**
     ...
     */
    where?: Maybe<BlogToBlogCategoryConnectionWhereArgs>;
  }) => Maybe<BlogToBlogCategoryConnection>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  blogId: ScalarsEnums["Int"];
  /**
  ...
  comments: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<BlogToCommentConnectionWhereArgs>;
  }) => Maybe<BlogToCommentConnection>;
  /**
  ...
  seriess: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<BlogToSeriesConnectionWhereArgs>;
  }) => Maybe<BlogToSeriesConnection>;
  /**
  ...
  /**
   * Connection between the Blog type and the TermNode type
   */
  terms: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<BlogToTermNodeConnectionWhereArgs>;
  }) => Maybe<BlogToTermNodeConnection>;
  /**
...
export interface BlogCategory {
   ...
   */
  blogCategoryId?: Maybe<ScalarsEnums["Int"]>;
  /**
   * Connection between the BlogCategory type and the Blog type
   */
  blogs: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<BlogCategoryToBlogConnectionWhereArgs>;
  }) => Maybe<BlogCategoryToBlogConnection>;
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
  /**
   * Connection between the BlogCategory type and the ContentNode type
   */
  contentNodes: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<BlogCategoryToContentNodeConnectionWhereArgs>;
  }) => Maybe<BlogCategoryToContentNodeConnection>;
  /**
  ...
  slug?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the BlogCategory type and the Taxonomy type
   */
 ...
 * Connection between the BlogCategory type and the Blog type
 */
export interface BlogCategoryToBlogConnection {
  __typename?: "BlogCategoryToBlogConnection";
  /**
   * Edges for the BlogCategoryToBlogConnection connection
   */
  edges?: Maybe<Array<Maybe<BlogCategoryToBlogConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Blog>>>;
  /**
 ...
 */
export interface BlogCategoryToBlogConnectionEdge {
  __typename?: "BlogCategoryToBlogConnectionEdge";
  /**
 ...
 * Connection between the BlogCategory type and the ContentNode type
 */
export interface BlogCategoryToContentNodeConnection {
  __typename?: "BlogCategoryToContentNodeConnection";
  /**
   * Edges for the BlogCategoryToContentNodeConnection connection
   */
 ...
 * An edge in a connection
 */
export interface BlogCategoryToContentNodeConnectionEdge {
 ...
 * Connection between the BlogCategory type and the Taxonomy type
 */
export interface BlogCategoryToTaxonomyConnectionEdge {
 ...
 * Connection between the Blog type and the BlogCategory type
 */
export interface BlogToBlogCategoryConnection {
  __typename?: "BlogToBlogCategoryConnection";
  /**
   * Edges for the BlogToBlogCategoryConnection connection
   */
  edges?: Maybe<Array<Maybe<BlogToBlogCategoryConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface BlogToBlogCategoryConnectionEdge {
  __typename?: "BlogToBlogCategoryConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the Blog type and the Comment type
 */
export interface BlogToCommentConnection {
  __typename?: "BlogToCommentConnection";
  /**
   * Edges for the BlogToCommentConnection connection
   */
  edges?: Maybe<Array<Maybe<BlogToCommentConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface BlogToCommentConnectionEdge {
 ...
 * Connection between the Blog type and the Blog type
 */
export interface BlogToPreviewConnectionEdge {
 ...
 * Connection between the Blog type and the Series type
 */
export interface BlogToSeriesConnection {
  __typename?: "BlogToSeriesConnection";
  /**
   * Edges for the BlogToSeriesConnection connection
   */
  edges?: Maybe<Array<Maybe<BlogToSeriesConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface BlogToSeriesConnectionEdge {
  __typename?: "BlogToSeriesConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the Blog type and the TermNode type
 */
export interface BlogToTermNodeConnection {
  __typename?: "BlogToTermNodeConnection";
  /**
   * Edges for the BlogToTermNodeConnection connection
   */
  edges?: Maybe<Array<Maybe<BlogToTermNodeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface BlogToTermNodeConnectionEdge {
  __typename?: "BlogToTermNodeConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the createDev mutation
 */
export interface CreateDevPayload {
  __typename?: "CreateDevPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface CreateStackoverflowPayload {
  __typename?: "CreateStackoverflowPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
   ...
   * The Post object mutation type.
   */
  stackoverflow?: Maybe<Stackoverflow>;
}
...
/**
 * The payload for the deleteBlogCategory mutation
 */
...
/**
 * The payload for the deleteDev mutation
 */
export interface DeleteDevPayload {
  __typename?: "DeleteDevPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the deleteStackoverflow mutation
 */
export interface DeleteStackoverflowPayload {
  __typename?: "DeleteStackoverflowPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface Dev {
  ...
  commentStatus?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the Dev type and the Comment type
   */
  comments: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
  ...
  guid?: Maybe<ScalarsEnums["String"]>;
  /**
   * The globally unique identifier of the dev object.
   */
  id: ScalarsEnums["ID"];
  /**
   * Whether the node is a Content Node
  ...
  modifiedGmt?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the Dev type and the Dev type
   */
  preview?: Maybe<DevToPreviewConnectionEdge>;
  /**
   * The database id of the preview node
   */
  previewRevisionDatabaseId?: Maybe<ScalarsEnums["Int"]>;
  ...
  seriess: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<DevToSeriesConnectionWhereArgs>;
  }) => Maybe<DevToSeriesConnection>;
  /**
   * The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table.
   */
  slug?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the Dev type and the Comment type
 */
export interface DevToCommentConnection {
  __typename?: "DevToCommentConnection";
  /**
   * Edges for the DevToCommentConnection connection
   */
  edges?: Maybe<Array<Maybe<DevToCommentConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Comment>>>;
 ...
 * An edge in a connection
 */
export interface DevToCommentConnectionEdge {
  __typename?: "DevToCommentConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the Dev type and the Dev type
 */
export interface DevToPreviewConnectionEdge {
  __typename?: "DevToPreviewConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Dev>;
 ...
 * Connection between the Dev type and the Dev type
 */
export interface DevToRevisionConnection {
  __typename?: "DevToRevisionConnection";
  /**
   * Edges for the DevToRevisionConnection connection
   */
  edges?: Maybe<Array<Maybe<DevToRevisionConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Dev>>>;
 ...
 * An edge in a connection
 */
export interface DevToRevisionConnectionEdge {
  __typename?: "DevToRevisionConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the Dev type and the Series type
 */
export interface DevToSeriesConnection {
  __typename?: "DevToSeriesConnection";
  /**
   * Edges for the DevToSeriesConnection connection
   */
  edges?: Maybe<Array<Maybe<DevToSeriesConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Series>>>;
 ...
 * An edge in a connection
 */
export interface DevToSeriesConnectionEdge {
  __typename?: "DevToSeriesConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface HierarchicalContentNode {
  __typename?: "MediaItem" | "Page" | "Stackoverflow";
  /**
...
export interface MenuItemThumbnail {
  __typename?: "MenuItemThumbnail";
  /**
   * 메뉴 라벨 색상
   */
  label_color?: Maybe<ScalarsEnums["String"]>;
  /**
   * 메뉴 아이콘 URL
   */
  menu_icon?: Maybe<ScalarsEnums["String"]>;
}
...
export interface NodeWithAuthor {
  __typename?: "Dev" | "MediaItem" | "Page" | "Post";
  /**
   * Connection between the NodeWithAuthor type and the User type
   */
  author?: Maybe<NodeWithAuthorToUserConnectionEdge>;
...
export interface NodeWithComments {
  __typename?: "Blog" | "Dev" | "MediaItem" | "Page" | "Post";
  /**
   * The number of comments. Even though WPGraphQL denotes this field as an integer, in WordPress this field should be saved as a numeric string for compatibility.
   */
  commentCount?: Maybe<ScalarsEnums["Int"]>;
...
/**
 * Connection between the RootQuery type and the BlogCategory type
 */
export interface RootQueryToBlogCategoryConnection {
  __typename?: "RootQueryToBlogCategoryConnection";
  /**
   * Edges for the RootQueryToBlogCategoryConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToBlogCategoryConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<BlogCategory>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToBlogCategoryConnectionEdge {
  __typename?: "RootQueryToBlogCategoryConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 */
export interface RootQueryToBlogConnection {
  __typename?: "RootQueryToBlogConnection";
  /**
   * Edges for the RootQueryToBlogConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToBlogConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Blog>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToBlogConnectionEdge {
...
export interface RootQueryToDevConnection {
  __typename?: "RootQueryToDevConnection";
  /**
   * Edges for the RootQueryToDevConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToDevConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Dev>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToDevConnectionEdge {
  __typename?: "RootQueryToDevConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 */
export interface RootQueryToSeriesConnection {
 ...
 * An edge in a connection
 */
export interface RootQueryToSeriesConnectionEdge {
...
export interface RootQueryToStackoverflowConnection {
  __typename?: "RootQueryToStackoverflowConnection";
  /**
   * Edges for the RootQueryToStackoverflowConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToStackoverflowConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Stackoverflow>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface RootQueryToStackoverflowConnectionEdge {
  __typename?: "RootQueryToStackoverflowConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface Series {
  __typename?: "Series";
  /**
   * Connection between the Series type and the Blog type
   */
  blogs: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<SeriesToBlogConnectionWhereArgs>;
  }) => Maybe<SeriesToBlogConnection>;
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
  ...
  }) => Maybe<SeriesToContentNodeConnection>;
  /**
   * The number of objects connected to the object
   */
  count?: Maybe<ScalarsEnums["Int"]>;
  ...
  description?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the Series type and the Dev type
   */
  devs: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<SeriesToDevConnectionWhereArgs>;
  }) => Maybe<SeriesToDevConnection>;
  /**
   * Connection between the TermNode type and the EnqueuedScript type
   */
  enqueuedScripts: (args?: {
   ...
   * @deprecated Deprecated in favor of databaseId
   */
  seriesId?: Maybe<ScalarsEnums["Int"]>;
  /**
   * An alphanumeric identifier for the object unique to its type.
   */
  slug?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the Series type and the Blog type
 */
export interface SeriesToBlogConnection {
  __typename?: "SeriesToBlogConnection";
  /**
   * Edges for the SeriesToBlogConnection connection
   */
  edges?: Maybe<Array<Maybe<SeriesToBlogConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Blog>>>;
 ...
 * An edge in a connection
 */
export interface SeriesToBlogConnectionEdge {
  __typename?: "SeriesToBlogConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the Series type and the ContentNode type
 */
export interface SeriesToContentNodeConnection {
 ...
 * An edge in a connection
 */
export interface SeriesToContentNodeConnectionEdge {
 ...
 * Connection between the Series type and the Dev type
 */
export interface SeriesToDevConnection {
  __typename?: "SeriesToDevConnection";
  /**
   * Edges for the SeriesToDevConnection connection
   */
  edges?: Maybe<Array<Maybe<SeriesToDevConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Dev>>>;
 ...
 * An edge in a connection
 */
export interface SeriesToDevConnectionEdge {
  __typename?: "SeriesToDevConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the Series type and the Taxonomy type
 */
export interface SeriesToTaxonomyConnectionEdge {
...
/**
 * The Stackoverflow type
 */
export interface Stackoverflow {
  __typename?: "Stackoverflow";
  /**
   * Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root).
   */
  ancestors: (args?: {
  ...
  guid?: Maybe<ScalarsEnums["String"]>;
  /**
   * The globally unique identifier of the stackoverflow object.
   */
  id: ScalarsEnums["ID"];
  /**
   * Whether the node is a Content Node
  ...
  parentId?: Maybe<ScalarsEnums["ID"]>;
  /**
   * Connection between the Stackoverflow type and the Stackoverflow type
   */
  preview?: Maybe<StackoverflowToPreviewConnectionEdge>;
  /**
   * The database id of the preview node
   */
  previewRevisionDatabaseId?: Maybe<ScalarsEnums["Int"]>;
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  stackoverflowId: ScalarsEnums["Int"];
  /**
   * The current status of the object
   */
  status?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the Stackoverflow type and the Stackoverflow type
 */
export interface StackoverflowToPreviewConnectionEdge {
  __typename?: "StackoverflowToPreviewConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Stackoverflow>;
...
/**
 * The payload for the UpdateBlogCategory mutation
 */
...
/**
 * The payload for the updateDev mutation
 */
export interface UpdateDevPayload {
  __typename?: "UpdateDevPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the updateStackoverflow mutation
 */
export interface UpdateStackoverflowPayload {
  __typename?: "UpdateStackoverflowPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface User {
  ...
  description?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the User type and the Dev type
   */
  devs: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToDevConnectionWhereArgs>;
  }) => Maybe<UserToDevConnection>;
  /**
 ...
 * Connection between the User type and the Dev type
 */
export interface UserToDevConnection {
  __typename?: "UserToDevConnection";
  /**
   * Edges for the UserToDevConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToDevConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Dev>>>;
 ...
 * An edge in a connection
 */
export interface UserToDevConnectionEdge {
  __typename?: "UserToDevConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface Mutation {
  __typename?: "Mutation";
  createBlog: (args: { input: CreateBlogInput }) => Maybe<CreateBlogPayload>;
  createBlogCategory: (args: {
    input: CreateBlogCategoryInput;
  }) => Maybe<CreateBlogCategoryPayload>;
  ...
  deleteBlog: (args: { input: DeleteBlogInput }) => Maybe<DeleteBlogPayload>;
  deleteBlogCategory: (args: {
    input: DeleteBlogCategoryInput;
  }) => Maybe<DeleteBlogCategoryPayload>;
  ...
  updateBlog: (args: { input: UpdateBlogInput }) => Maybe<UpdateBlogPayload>;
  updateBlogCategory: (args: {
    input: UpdateBlogCategoryInput;
  }) => Maybe<UpdateBlogCategoryPayload>;
...
export interface Query {
  __typename?: "Query";
  allBlogCategory: (args?: {
    after?: Maybe<Scalars["String"]>;
    before?: Maybe<Scalars["String"]>;
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToBlogCategoryConnectionWhereArgs>;
  }) => Maybe<RootQueryToBlogCategoryConnection>;
  allSettings?: Maybe<Settings>;
  allUrls?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  blog: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<BlogIdType>;
  }) => Maybe<Blog>;
  blogBy: (args?: {
  ...
  blogCategory: (args: {
    id: Scalars["ID"];
    idType?: Maybe<BlogCategoryIdType>;
  }) => Maybe<BlogCategory>;
  blogs: (args?: {
    after?: Maybe<Scalars["String"]>;
    before?: Maybe<Scalars["String"]>;
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToBlogConnectionWhereArgs>;
  }) => Maybe<RootQueryToBlogConnection>;
  book: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
  ...
  dev: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<DevIdType>;
  }) => Maybe<Dev>;
  devBy: (args?: {
    devId?: Maybe<Scalars["Int"]>;
    id?: Maybe<Scalars["ID"]>;
    slug?: Maybe<Scalars["String"]>;
    uri?: Maybe<Scalars["String"]>;
  }) => Maybe<Dev>;
  ...
  devs: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToDevConnectionWhereArgs>;
  }) => Maybe<RootQueryToDevConnection>;
  discussionSettings?: Maybe<DiscussionSettings>;
  generalSettings?: Maybe<GeneralSettings>;
  mediaItem: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
  ...
  }) => Maybe<RootQueryToSeriesConnection>;
  shortcutPost: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
  ...
  stackoverflow: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<StackoverflowIdType>;
  }) => Maybe<Stackoverflow>;
  stackoverflowBy: (args?: {
    id?: Maybe<Scalars["ID"]>;
    stackoverflowId?: Maybe<Scalars["Int"]>;
    uri?: Maybe<Scalars["String"]>;
  }) => Maybe<Stackoverflow>;
  stackoverflows: (args?: {
    after?: Maybe<Scalars["String"]>;
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToStackoverflowConnectionWhereArgs>;
  }) => Maybe<RootQueryToStackoverflowConnection>;
...
export interface SchemaObjectTypes {
  ...
  BlogToCommentConnectionEdge: BlogToCommentConnectionEdge;
  BlogToPreviewConnectionEdge: BlogToPreviewConnectionEdge;
  BlogToSeriesConnection: BlogToSeriesConnection;
  BlogToSeriesConnectionEdge: BlogToSeriesConnectionEdge;
  ...
  CreateBlogCategoryPayload: CreateBlogCategoryPayload;
  CreateBlogPayload: CreateBlogPayload;
  ...
  DeleteBlogCategoryPayload: DeleteBlogCategoryPayload;
  DeleteBlogPayload: DeleteBlogPayload;
  ...
  DevToSeriesConnection: DevToSeriesConnection;
  DevToSeriesConnectionEdge: DevToSeriesConnectionEdge;
  ...
  RootQueryToBlogCategoryConnection: RootQueryToBlogCategoryConnection;
  RootQueryToBlogCategoryConnectionEdge: RootQueryToBlogCategoryConnectionEdge;
  RootQueryToBlogConnection: RootQueryToBlogConnection;
  RootQueryToBlogConnectionEdge: RootQueryToBlogConnectionEdge;
  ...
  RootQueryToSeriesConnection: RootQueryToSeriesConnection;
  RootQueryToSeriesConnectionEdge: RootQueryToSeriesConnectionEdge;
  ...
  SeriesToContentNodeConnectionEdge: SeriesToContentNodeConnectionEdge;
  SeriesToDevConnection: SeriesToDevConnection;
  SeriesToDevConnectionEdge: SeriesToDevConnectionEdge;
  SeriesToTaxonomyConnectionEdge: SeriesToTaxonomyConnectionEdge;
  Settings: Settings;
  ...
  Theme: Theme;
  UpdateBlogCategoryPayload: UpdateBlogCategoryPayload;
  UpdateBlogPayload: UpdateBlogPayload;
  ...
  UserToDevConnection: UserToDevConnection;
  UserToDevConnectionEdge: UserToDevConnectionEdge;

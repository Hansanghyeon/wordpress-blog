        ...
        <Container>
            ...
            <Col col>
              ...
              <div>
                ...
                <p>
                  ...
                  싶었고 그리고 내가 이 영화를보고 어떤 것들을 느꼇는지
                  기록했었죠
                </p>
              </div>
            </Col>
          ...
          <Row>
            <Col col>
              ...
              <div>
                <p>
                  네이버 블로그를 운영하면서 블로그 스킨, 자유로운 커스텀에
                  이끌려 티스토리로 이전해왔습니다.
                </p>
              </div>
            </Col>
          ...
          <Row>
            <Col col>
              ...
              <div>
                ...
                <p>
                  티스토리와는 다르게 플러그인이라는 개념이있어서 유용한
                  기능들을 플러그인을 통해서 경험할 수 있어서 이전을 결정했던
                  것같아요
                </p>
                <p>
                  워드프레스에서는 컨텐츠를 관리하고 유저를 관리하고 여기서
                  멈추지 않고 직접 필요한 유틸리티를 개발해서 사용할 수 있고
                  이런 부분이 매력적이어서 계속 사용하고있습니다
                </p>
              </div>
            </Col>
          </Row>
